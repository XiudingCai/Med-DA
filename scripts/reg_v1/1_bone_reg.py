...
if __name__ == '__main__':
    ...
    for name in os.listdir(os.path.join(base_dir, 'MRI', 'bone_labels')):
        images.append({
            'fixed': os.path.join(base_dir, 'CT', 'bone_labels', name),
            'moving': os.path.join(base_dir, 'MRI', 'bone_labels', name),
            'to_moving': [os.path.join(base_dir, 'MRI', 'images', name.replace('bone', 'image')),

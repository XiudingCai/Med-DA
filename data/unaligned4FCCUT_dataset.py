...
class Unaligned4FCCUTDataset(BaseDataset):
    """
    ...
    def __getitem__(self, index):
        ...
        if self.opt.isTrain:
            ...
            return {'A': A, 'B': B, 'R': R, 'A_pre': A_pre, 'R_pre': R_pre,
                    'A_paths': A_path, 'B_paths': B_path, 'R_paths': R_path,
                    'A_pre_paths': A_pre_path, 'R_pre_paths': R_pre_path}
        else:

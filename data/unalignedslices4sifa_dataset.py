...
class UnalignedSlices4SIFADataset(BaseDataset):
    """
    ...
    def __init__(self, opt):
        ...
        if opt.phase == 'test':
            self.dir_A = "/home/cas/home_ez/Datasets/MPSCL/data/data_np/test_ct"
            self.dir_B = "/home/cas/home_ez/Datasets/MPSCL/data/data_np/test_mr"
            self.dir_A_gt = "/home/cas/home_ez/Datasets/MPSCL/data/data_np/gt_test_ct"
            self.dir_B_gt = "/home/cas/home_ez/Datasets/MPSCL/data/data_np/gt_test_mr"
...
def get_transform(opt, keys=['image'], label=False):
    ...
    train_transform = transforms.Compose(
        [
            ...
            transforms.Resized(keys=keys, spatial_size=(256, 256),
                               mode=mode),
            # CheckDim(keys=keys),
    ...
    val_transform = transforms.Compose(
        [
            ...
            transforms.Resized(keys=keys, spatial_size=(256, 256), mode=mode),
            # transforms.Rotate90d(keys=keys, k=2, spatial_axes=(0, 1)),
            transforms.ToTensord(keys=keys),
        ]
    )

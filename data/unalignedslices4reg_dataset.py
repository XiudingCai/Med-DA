...
class UnalignedSlices4RegDataset(BaseDataset):
    """
...
def get_transform(opt, keys=['image']):
    ...
    MAX = 1.
    if 'MR2CT' in DATASET:
        opt.padding_size = (176, 176, 64)
        opt.patch_size = (176, 176, 3)
        ...
        train_transform = transforms.Compose(
            [
                ...
                transforms.SpatialPadd(keys=keys,
                                       spatial_size=(opt.padding_size[0], opt.padding_size[1], opt.padding_size[2])),
                ...
                transforms.Resized(keys=keys, spatial_size=(opt.resize_size[0], opt.resize_size[1], opt.resize_size[2])),

...
class Unaligned4BraTSDataset(BaseDataset):
    """
    ...
    def __getitem__(self, index):
        ...
        index = A_path.rfind('_')
        prefix, idxpng = A_path[:index], A_path[index+1:]
        ...
        index = B_path.rfind('_')
        prefix, idxpng = B_path[:index], B_path[index+1:]
        idx, png = idxpng.split('.')

...
class EnCoV3Model(BaseModel):
    ...
    def set_input(self, input):
        ...
        self.real_A = input['A' if AtoB else 'B'].to(self.device) + 1e-7
        self.real_B = input['B' if AtoB else 'A'].to(self.device) + 1e-7
        # print(self.real_A.min(), self.real_B.min(), self.real_A.max(), self.real_B.max())
        # print(self.real_A)

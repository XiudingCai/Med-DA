...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02,
    ...
    if netG == 'resnet_9blocks':
        ...
        net = ResnetPONOMSGenerator(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout,
                                    n_blocks=9)
    elif netG == 'resnetPONODMS_9blocks':
        net = ResnetPONODMSGenerator(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout,
                                     n_blocks=9)
...
class Conv2dBlock(nn.Module):
    def __init__(self, inputdim, outputdim, operation, use_bias, use_relu=True, relu=True, ms=False, pono=False,
                 norm=True, front=False, normtype=nn.BatchNorm2d, kerneltype=3):

...
class LPTN(nn.Module):
    def __init__(self, nrb_low=5, nrb_high=3, num_high=3, output_nc=3):
        ...
        self.out = torch.nn.Conv2d(3, output_nc, 1, padding=0)
    ...
    def forward(self, real_A_full):
        ...
        return self.out(fake_B_full)


if __name__ == '__main__':
    model = LPTN(output_nc=1).cuda()

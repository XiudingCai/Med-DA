...
from .patchnce import PatchNCELoss, PatchNCELoss2, StylePatchNCELoss2
import util.util as util


class CUTPPModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A', 'fake_B', 'real_B', 'real_S']
    ...
    def compute_D_loss(self):
        ...
        # self.loss_D = self.calculate_StyleNCE_loss(pred_fake, self.real_B, self.real_S)
    ...
    def compute_G_loss(self):
        ...
        if self.opt.lambda_NCE > 0.0:
            ...
            self.loss_StyleNCE = self.calculate_StyleNCE_loss(fake, self.real_S, self.real_B)
        else:
    ...
    #
    #     num_patches = -1
    #     feat_k_pool, _ = self.netF(feat_k, num_patches, None)
    #     feat_q_pool, _ = self.netF(feat_q, num_patches, None)
    #
    #     total_nce_loss = 0.0
    #     for f_q, f_k, crit, nce_layer in zip(feat_q_pool, feat_k_pool, self.criterionStyleNCE, nce_layers):
    #         print(f_q.shape, f_k.shape)
    #         loss = crit(f_q, f_k) * self.opt.lambda_NCE
    #         total_nce_loss += loss.mean()
    #
    #     return total_nce_loss / n_layers

...
class CUTCLDModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            self.criterionCLD = networks.GANLoss('l1', target_real_label=1.0, target_fake_label=-1.0).to(self.device)
            self.criterionNCE = []
    ...
    def compute_D_loss(self):
        ...
        pred_7, pred_1 = self.netD(torch.cat([fake, self.real_B], dim=0))
        print(pred_1)

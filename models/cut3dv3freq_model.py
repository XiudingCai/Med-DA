...
class CUT3Dv3freqModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_GAN', 'D', 'G', 'NCE', 'FFT']
    ...
    def compute_G_loss(self):
        ...
        real_fft = self.convert_fft(self.real_B)

        self.loss_FFT = self.criterionIdt(fake_fft, real_fft)
        ...
        self.loss_G = self.loss_G_GAN + loss_NCE_both + self.loss_FFT
        return self.loss_G

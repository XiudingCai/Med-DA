...
class CycleGANNDModel(BaseModel):
    """
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            real_list = [torch.rot90(self.real_A.squeeze(1).transpose(1, 3), k=2, dims=(2, 3))]
            fake_list = [torch.rot90(fakes.squeeze(1).transpose(1, 3), k=2, dims=(2, 3))]

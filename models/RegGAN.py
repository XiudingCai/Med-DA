...
class Reg(nn.Module):
    def __init__(self, in_channel=1, height=256, width=256):
        super(Reg, self).__init__()
        height, width = height, width
        in_channels_a, in_channels_b = in_channel, in_channel
        init_func = 'kaiming'
    ...
    def forward(self, img_a, img_b, apply_on=None):
        ...
        image_reg = self.spatial_transform(img_a, deformations)

        return image_reg, deformations
